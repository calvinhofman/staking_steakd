import {
  ...
  watchAccount,
  watchNetwork
} from "./chunk-5VSHJIAW.js";
import "./chunk-LWFY2OFN.js";
import "./chunk-OAKA7YDO.js";
import "./chunk-RMZ32BZT.js";
import {
  SwitchChainError,
  UserRejectedRequestError,
  getAddress,
  numberToHex
} from "./chunk-HAEE2ELK.js";
import "./chunk-J7C6OMUU.js";
...
initProvider_fn = async function() {
  const {
    ...
    OPTIONAL_EVENTS,
    OPTIONAL_METHODS
  } = await import("./index.es-RQYVLUHH.js");
...
var WalletConnectLegacyConnector = class extends Connector {
  ...
  async getProvider({
    ...
    if (!__privateGet(this, _provider2) || chainId || create) {
      ...
      const WalletConnectProvider = (await import("./esm-ST7PJZ6T.js")).default;
      __privateSet(this, _provider2, new WalletConnectProvider({
        ...this.options,
        chainId,
        rpc: { ...rpc, ...(_b = this.options) == null ? void 0 : _b.rpc }
      }));
      __privateGet(this, _provider2).http = await __privateGet(this, _provider2).setHttpProvider(chainId);
    }
...
// node_modules/@web3modal/ethereum/dist/index.es.js
var P = "wallet_addEthereumChain";
var L = class {
  constructor(n, t) {
  ...
  getWalletConnectConnectors() {
    const n = this.wagmi.connectors.find((o) => o.id === "walletConnect"), t = this.wagmi.connectors.find((o) => o.id === "walletConnectLegacy"), e = n ?? t;
    if (!e)
  ...
  async connectWalletConnectV1(n, t) {
    return new Promise((e, o) => {
      n.once("message", async ({ type: i }) => {
        if (i === "connecting") {
          const c = (await n.getProvider()).connector;
          t(c.uri), c.on("disconnect", () => {
            o(Error());
          }), c.on("connect", () => {
            e();
          });
  ...
  async connectWalletConnectV2(n, t) {
    return await n.getProvider(), new Promise((e) => {
      n.once("message", (o) => {
        o.type === "display_uri" && (t(o.data), e());
      });
    });
  }
  getConnectorById(n) {
  ...
  async connectWalletConnect(n, t) {
    const { connector: e, isV2: o } = this.getWalletConnectConnectors(), i = { connector: e };
    t && (i.chainId = t);
    const c = o ? this.connectWalletConnectV2.bind(this) : this.connectWalletConnectV1.bind(this);
    return Promise.all([connect(i), c(e, n)]);
  }
  async connectConnector(n, t) {
    const e = { connector: this.getConnectorById(n) };
    return t && (e.chainId = t), await connect(e);
  }
  isInjectedProviderInstalled() {
    return typeof window.ethereum < "u";
  }
  safeCheckInjectedProvider(n) {
    var t;
    try {
      const e = String(n);
      return !!((t = window.ethereum) != null && t[e]);
    } catch (e) {
  ...
  async getConnectedChainIds() {
    var n, t, e;
    const { connector: o, isV2: i } = this.getWalletConnectConnectors();
    if (i) {
      const c = (t = (n = (await o.getProvider()).signer) == null ? void 0 : n.session) == null ? void 0 : t.namespaces, l = (e = c == null ? void 0 : c[this.namespace]) == null ? void 0 : e.methods;
      if (l != null && l.includes(P))
        return "ALL";
      if (c) {
        const a = [];
        return Object.keys(c).forEach((s) => {
          s.includes(this.namespace) && a.push(...c[s].accounts);
        }), a == null ? void 0 : a.map((s) => s.split(":")[1]);
      }
    }
    return "ALL";
  }
...
var k = "eip155";
function b({ projectId: r }) {
  return jsonRpcProvider({ rpc: (n) => {
    var t;
    return [1, 3, 4, 5, 10, 42, 56, 69, 97, 100, 137, 280, 324, 420, 42161, 42220, 43114, 80001, 421611, 421613, 1313161554, 1313161555].includes(n.id) ? { http: `https://rpc.walletconnect.com/v1/?chainId=${k}:${n.id}&projectId=${r}` } : { http: n.rpcUrls.default.http[0], webSocket: (t = n.rpcUrls.default.webSocket) == null ? void 0 : t[0] };
  } });
}
function B({ chains: r, version: n, projectId: t }) {
  const e = n === 1, o = [new InjectedConnector({ chains: r })];
  return e ? o.unshift(new WalletConnectLegacyConnector({ chains: r, options: { qrcode: false } })) : o.unshift(new WalletConnectConnector({ chains: r, options: { projectId: t, showQrModal: false } })), o;
}
export {
  L as EthereumClient,
  B as w3mConnectors,
