...
import {
  ...
  watchAccount,
  watchNetwork
} from "./chunk-QBQVJS3R.js";
import "./chunk-ZCKXISHH.js";
import "./chunk-PH6OLYHC.js";
...
import {
  ...
  getAddress,
  numberToHex
} from "./chunk-U6MELXYF.js";
import "./chunk-6LBGNKKP.js";
import "./chunk-JZQ37OGZ.js";

// node_modules/@wagmi/core/node_modules/@wagmi/connectors/dist/walletConnect.js
...
initProvider_fn = async function() {
  const { EthereumProvider, OPTIONAL_EVENTS, OPTIONAL_METHODS } = await import("./index.es-VMRQ5RMF.js");
...
function N({ projectId: c }) {
  return jsonRpcProvider({ rpc: (t) => {
    var e;
    return [1, 3, 4, 5, 10, 42, 56, 69, 97, 100, 137, 280, 324, 420, 42161, 42220, 43114, 80001, 421611, 421613, 1313161554, 1313161555].includes(t.id) ? { http: `https://rpc.walletconnect.com/v1/?chainId=${E}:${t.id}&projectId=${c}` } : { http: t.rpcUrls.default.http[0], webSocket: (e = t.rpcUrls.default.webSocket) == null ? void 0 : e[0] };
  } });
}
