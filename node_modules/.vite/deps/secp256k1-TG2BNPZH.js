...
function tonelliShanks(P) {
  ...
  return function tonelliSlow(Fp2, n) {
    ...
    while (!Fp2.eql(b, Fp2.ONE)) {
      ...
      const ge2 = Fp2.pow(g, _1n << BigInt(r - m - 1));
      g = Fp2.sqr(ge2);
      x = Fp2.mul(x, ge2);
      b = Fp2.mul(b, g);
      r = m;
...
function SWUFpSqrtRatio(Fp2, Z) {
  ...
  for (let o = q - _1n3; o % _2n2 === _0n3; o /= _2n2)
    l += _1n3;
  const c1 = l;
  const c2 = (q - _1n3) / _2n2 ** c1;
  const c3 = (c2 - _1n3) / _2n2;
  const c4 = _2n2 ** c1 - _1n3;
  const c5 = _2n2 ** (c1 - _1n3);
...
var _0n4 = BigInt(0);
var fe = (x) => typeof x === "bigint" && _0n4 < x && x < secp256k1P;
var ge = (x) => typeof x === "bigint" && _0n4 < x && x < secp256k1N;
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=secp256k1-TG2BNPZH.js.map
