...
var UnknownNodeError = class extends BaseError {
  constructor({ cause }) {
    super(`An error occurred while executing: ${cause == null ? void 0 : cause.message}`, {
      cause
    });
    Object.defineProperty(this, "name", {
      enumerable: true,
...
function getNodeError(err, args) {
  ...
  else if (message.match(ExecutionRevertedError.nodeMessage) || "code" in err.cause && ((_a = err.cause) == null ? void 0 : _a.code) === ExecutionRevertedError.code)
...
function defineFormatter({ format: format2 }) {
  return ({ exclude, format: formatOverride }) => (data) => {
    ...
    return {
      ...formatted,
      ...formatOverride == null ? void 0 : formatOverride(data)
    };
  };
}
...
async function call(client, args) {
  var _a, _b, _c;
  const { account: account_, batch = Boolean((_a = client.batch) == null ? void 0 : _a.multicall), blockNumber, blockTag = "latest", accessList, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to, value, ...rest } = args;
  const account = account_ ? parseAccount(account_) : void 0;
  try {
    assertRequest(args);
    const blockNumberHex = blockNumber ? numberToHex(blockNumber) : void 0;
    const block = blockNumberHex || blockTag;
    const formatter = (_c = (_b = client.chain) == null ? void 0 : _b.formatters) == null ? void 0 : _c.transactionRequest;
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-GWQHMMGM.js");
...
async function scheduleMulticall(client, args) {
  var _a, _b;
  const { batchSize = 1024, wait = 0 } = typeof ((_a = client.batch) == null ? void 0 : _a.multicall) === "object" ? (_b = client.batch) == null ? void 0 : _b.multicall : {};
...
//# sourceMappingURL=chunk-JFQG4CIS.js.map
